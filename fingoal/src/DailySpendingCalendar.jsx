...
// import { getDailySeries } from "./data/txStore";   // if this file lives under /pages, use ../data/txStore
...
//           const incPct = maxIncome > 0 ? Math.round((inc / maxIncome) * 100) : 0;
//           const outPct = maxOutcome > 0 ? Math.round((out / maxOutcome) * 100) : 0;
...
//               {/* Amounts: render ONLY when there is data */}
//               <div
//                 style={{
//                   marginTop: 8,
//                   display: "grid",
...
//                 {inc > 0 && (
//                   <>
//                     <div style={{ fontSize: 16, fontWeight: 900, color: "#065f46" }}>+{money(inc)}</div>
//                     <div style={{ height: 8, background: "#f3f4f6", borderRadius: 999, overflow: "hidden" }}>
//                       <div style={{ width: `${incPct}%`, height: "100%", background: "#10b981" }} />
//                     </div>
//                   </>
//                 )}
...
//                 {out > 0 && (
//                   <>
//                     <div style={{ fontSize: 16, fontWeight: 900, color: "#7f1d1d" }}>-{money(out)}</div>
//                     <div style={{ height: 8, background: "#f3f4f6", borderRadius: 999, overflow: "hidden" }}>
//                       <div style={{ width: `${outPct}%`, height: "100%", background: "#ef4444" }} />
//                     </div>
//                   </>
//                 )}
//               </div>
...
//         Bars are scaled independently: income (green) vs spending (red), each relative to that month’s own max.
//       </div>
//     </div>
//   );
// }
